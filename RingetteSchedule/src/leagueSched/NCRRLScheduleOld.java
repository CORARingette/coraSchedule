...
public class NCRRLScheduleOld extends AbstractLeagueSchedule {

	private static final Logger LOGGER = Logger.getLogger(NCRRLScheduleOld.class.getName());
	...
	public static void main(String[] args) throws ParserException {
		...
		NCRRLScheduleOld loader = new NCRRLScheduleOld("U14 Tween A Wippel");
		SimpleDateFormat formatter = new SimpleDateFormat("dd/MM/yyyy");
		try {

			List<ScheduleRecord> records = loader.findEntriesForDay(formatter.parse("02/01/2016"));
			for (int i = 0; i < records.size(); i++) {
				NCRRLScheduleOld.LOGGER.info(records.get(i).getHome() + ":" + records.get(i).getVisitor() + ":"
